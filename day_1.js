...
if (numeroUn == stringUn) {  // Usando == para comparar solo los valores
...
if (numeroTreinta == stringTreinta) {  // Usando == para comparar solo los valores
...
if (numeroDiez == stringDiez) {  // Usando == para comparar solo los valores
